window.BMAP_AUTHENTIC_KEY = "ZhLk4nT0kNMRRT9Dtz9BYgRjghS7xO9g"; (function() {
    function aa(a) {
        throw a;
    }
    var j = void 0,
    ...
    var F = {
        ...
        XF: new L(13, 1),
        pa: z.ma + "images/",
        R2: "https://api0.map.bdimg.com/images/",
    ...
    var $a; (function() {
        ...
        var l = {
            send: function(a) {
                ...
                function(a, b) {
                    e.push(a + "=" + b)
                }), e.push("d=[" + c.join(",") + "]"), g ? e.push("_st=" + g) : e.push("_t=" + +new Date), f = new Image, f.src = "https://static.tieba.baidu.com/tb/pms/img/st.gif?" + e.join("&"), window["___pms_img_" + 1 * new Date] = f)
            }
        };
        a.prototype = {
            pc: function(a, b) {
    ...
    "2" !== z.ou && (function(a, b, c) { (function(a, b, c) {
            ...
            if (k && k.an && i() < k.an) {
                ...
                c.alog("monkey.create", {
                    ...
                    pid: "241",
                    p: "18",
                    ky: "https://nsclick.baidu.com/u.gif",
                    M3: {
                        K3: 1
                    }
                });
            ...
            function(a) {
                ...
                dv: 3,
                ky: "https://static.tieba.baidu.com/tb/pms/img/st.gif",
                page: g,
                p: "18"
            }))
        })(a, b, c)
